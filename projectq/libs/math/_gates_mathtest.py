...
def test_comparator():
    ...
    assert 1. == pytest.approx(eng.backend.get_probability([0,0,0,0,1], qunum_a))
    assert 1. == pytest.approx(eng.backend.get_probability([0,0,0,1,0], qunum_b))
...
def test_conditionaladd():
    ...
    assert 1. == pytest.approx(eng.backend.get_probability([0,0,0,0,1], qunum_a))
    assert 1. == pytest.approx(eng.backend.get_probability([0,0,0,1,1], qunum_b))
...
def test_conditionaladdcarry():
    ...
    assert 1. == pytest.approx(eng.backend.get_probability([0,1,0,0], qunum_a))
    assert 1. == pytest.approx(eng.backend.get_probability([1,0,0,0], qunum_b))
...
def test_multiplication():
    ...
    assert 1. == pytest.approx(eng.backend.get_probability([0,0,1,0,0], qunum_a))
    assert 1. == pytest.approx(eng.backend.get_probability([0,0,0,1,0], qunum_b))
    assert 1. == pytest.approx(eng.backend.get_probability([0,0,0,0,0,1,0,0,0], qunum_c))
