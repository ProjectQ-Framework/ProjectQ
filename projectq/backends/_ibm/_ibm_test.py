...
@pytest.mark.parametrize("single_qubit_gate, is_available", [
    (X, False), (Y, False), (Z, False), (H, True), (T, False), (Tdag, False), (S, False),
...
def test_ibm_retrieve(monkeypatch):
    ...
    def mock_retrieve(*args, **kwargs):
        ...
        'header': {'clbit_labels': [['c', 0], ['c', 1], ['c', 2], ['c', 3]],
                ...
                'name': 'circuit0',
                'qreg_sizes': [['q', 32]],
                'qubit_labels': [['q', 0], ['q', 1], ['q', 2], ['q', 3], ['q', 4], ['q', 5],
        ...
        'metadata': {'measure_sampling': True, 'method': 'statevector', 'parallel_shots': 1,
...
def test_ibm_backend_functional_test(monkeypatch):
    ...
    #to return the correct values for a subset of the total register
    unused_qubit = eng.allocate_qubit()
    qureg = eng.allocate_qureg(3)
    # entangle the qureg
    Entangle | qureg
